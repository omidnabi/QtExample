...
mkdir %BUILD_DIR%
cd %BUILD_DIR%
"%CMAKE_PATH%\cmake.exe"-S . -B build -G "Visual Studio 17 2022" -A x64 -DCMAKE_PREFIX_PATH=C:\Qt\6.7.0\msvc2019_64\lib\cmake\Qt6
...
mkdir %BUILD_DIR%
cd %BUILD_DIR%
"%CMAKE_PATH%\cmake.exe" -S .. -B . -G "Visual Studio 17 2022" -A x64 -DCMAKE_PREFIX_PATH=C:\Qt\6.7.0\msvc2019_64\lib\cmake\Qt6\
"%CMAKE_PATH%\cmake.exe" --build . --config Release
